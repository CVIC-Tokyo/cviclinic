              ...
              <form onSubmit={onSubmit}>
                <div className='flex flex-col py-2 w-full h-auto'>
                  <div className='grid grid-cols-2 py-2'>
                    ...
                    <div>
                      <label className='uppercase text-sm py-3'>surname <span className='text-red-500'>*</span></label>
                      <input
                ...
                <button disabled={hasEmpty} className={`flex justify-center items-center rounded-xl shadow-lg w-full p-5 mt-5 ${hasEmpty ? 'cursor-not-allowed bg-red-200' : 'bg-[#820000]'}`}>{isLoading && !messageSent ? <AiOutlineReload className='animate-spin'/> :'Send'}</button>
              </form>
              {
